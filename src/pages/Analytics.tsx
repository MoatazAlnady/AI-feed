  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      try {
        ...
        // const response = await fetch(`/api/analytics?timeRange=${timeRange}&contentFilter=${contentFilter}`);
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left py-3 px-4 font-semibold text-gray-900">Reach</th>
