                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {dashboardLoading ? (
                      ...
                      [
                        ...
                        { label: 'Saved Items', value: dashboardStats?.savedItems || 0, icon: Bookmark, color: 'text-yellow-500', link: '/profile' },
                      ].map((stat) => (
                      ...
                      <CardContent>
                        {dashboardLoading ? (
                          ...
                          <p className="text-sm text-muted-foreground text-center py-4">
                            No tools submitted yet. <Link to="/tools/create" className="text-primary hover:underline">Submit your first tool</Link>
                          </p>
                        )}
                      </CardContent>
                    </Card>
