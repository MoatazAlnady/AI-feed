        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
          ...
          <div className="flex items-center space-x-2">
            ...
            <a
              ...
              className="flex items-center px-3 py-1.5 text-xs font-medium bg-primary text-primary-foreground hover:bg-primary/90 dark:bg-primary dark:text-primary-foreground dark:hover:bg-primary/90 rounded-md transition-colors group"
            >
              <span>Try Now</span>
