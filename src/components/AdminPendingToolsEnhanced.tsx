                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="w-16 h-16 rounded-lg p-1 bg-background ml-4">
                          {selectedTool.logo_url ? (
                            <img 
                              src={selectedTool.logo_url} 
                              alt={`${selectedTool.name} logo`}
                              ...
                              onError={(e) => {
                                ...
                                if (parent) {
                                  parent.innerHTML = `<div class="w-full h-full bg-muted rounded flex items-center justify-center"><span class="text-sm text-muted-foreground font-medium">${selectedTool.name.charAt(0).toUpperCase()}</span></div>`;
                                }
                              }}
                            />
                          ) : (
