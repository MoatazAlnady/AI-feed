    ...
    <>
      <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
        <DropdownMenuTrigger asChild>
          <button className="p-1 hover:bg-gray-100 dark:hover:bg-[hsl(var(--color-surface-menu-dark))] rounded-full transition-colors">
            <MoreHorizontal className="h-4 w-4 text-gray-500 dark:text-gray-400" />
          </button>
        </DropdownMenuTrigger>
        <DropdownMenuContent align="end" className="w-48 bg-white dark:bg-[hsl(var(--color-surface-menu-dark))]">
          {/* Owner actions */}
          {isOwner && (
            <>
