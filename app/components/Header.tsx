...
const Header: React.FC = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    if (searchTerm.trim()) {
      if (isEmployerView) {
        router.push(`/employer/talents?search=${encodeURIComponent(searchTerm.trim())}`);
      } else {
  ...
  return (
    <>
      <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-100 dark:border-gray-700 sticky top-0 z-40 backdrop-blur-sm bg-white/95 dark:bg-gray-800/95">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            {/* Logo */}
            <Link href={isEmployerView ? "/employer" : "/"} className="flex items-center space-x-3 group flex-shrink-0">
              ...
              {isEmployerView && (
                <>
                  ...
                  <Link
                    ...
                    className={`nav-link px-3 py-2 text-sm font-medium rounded-md transition-all duration-300 whitespace-nowrap ${
                      pathname?.includes('/employer/talents')
                        ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/30 active'
                        : 'text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700'
                    }`}
                  >
                  ...
                  <Link
                    href="/employer/jobs"
                    className={`nav-link px-3 py-2 text-sm font-medium rounded-md transition-all duration-300 whitespace-nowrap ${
                      pathname?.includes('/employer/jobs')
                        ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/30 active'
                        : 'text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700'
                    }`}
                  >
                  ...
                  <Link
                    ...
                    className={`nav-link px-3 py-2 text-sm font-medium rounded-md transition-all duration-300 whitespace-nowrap ${
                      pathname?.includes('/employer/projects')
                        ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/30 active'
                        : 'text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700'
                    }`}
                  >
                  ...
                  <Link
                    ...
                    className={`nav-link px-3 py-2 text-sm font-medium rounded-md transition-all duration-300 whitespace-nowrap ${
                      pathname?.includes('/employer/analytics')
                        ? 'text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/30 active'
                        : 'text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-50 dark:hover:bg-gray-700'
                    }`}
                  >
            ...
            <div className="flex items-center space-x-3 flex-shrink-0">
              ...
              <button 
                onClick={() => router.push(isEmployerView ? '/employer/talents' : '/tools')}
              ...
              {user ? (
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-primary-500 to-secondary-500 text-white text-sm font-medium rounded-lg hover:shadow-lg transition-all duration-200 transform hover:scale-105"
                    id="signupBtn"
                  >
                    Sign In
                  </button>
                ...
                {user ? (
                  ...
                  <div className="pt-2 border-t border-gray-100 dark:border-gray-700 space-y-2">
                    <button
                      ...
                      className="w-full text-left px-3 py-2 text-base font-medium bg-gradient-to-r from-primary-500 to-secondary-500 text-white rounded-md transition-colors"
                      id="signupBtn"
                    >
                      Sign In
                    </button>
